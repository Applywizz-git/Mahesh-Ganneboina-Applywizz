...
export default function Skills() {
  ...
  const categoryColors = {
    'AI & Machine Learning': 'text-blue-500',
    'Cloud & Infrastructure': 'text-green-500',
    'Data Engineering': 'text-purple-500',
    'Programming & Tools': 'text-orange-500',
  };
        ...
        >
          ...
          <motion.div variants={itemVariants} className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Advanced technical capabilities across AI, cloud platforms, and modern development stacks
            </p>
          </motion.div>
